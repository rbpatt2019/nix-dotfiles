{
  programs.fzf = {
    ...
    fileWidgetOptions = [ "-m --preview='bat --plain -r 1:15 -P --color always {}' --preview-window down:15:hidden:wrap" ];
    changeDirWidgetCommand = "fd --type d --hidden --exclude '.git'";
    changeDirWidgetOptions = [ "--preview 'tree -C {} | head -15' --preview-window down:15:hidden:wrap" ];
